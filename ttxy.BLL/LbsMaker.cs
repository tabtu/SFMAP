...
namespace ttxy.BLL
{
    ...
    public class LbsMaker
    {
        ...
        {
            string key = StrUtil.key_TDT;
            string h0 = "<html>\r\n<head>\r\n    <meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\"/>\r\n    <title>贵阳法治地图</title>\r\n    <script type=\"text/javascript\" src=\"http://api.tianditu.gov.cn/api?v=3.0&tk=" + key + "\"></script>\r\n    <style type=\"text/css\">\r\n        body, html {\r\n            width: 100%;\r\n            height: 100%;\r\n            margin: 0;\r\n            font-family: \"微软雅黑\";\r\n        }\r\n        #mapDiv {\r\n            height: 100%;\r\n            width: 100%;\r\n        }\r\n    </style>\r\n    <script>\r\n        var map;\r\n        function onLoad() {\r\n            map = new T.Map(\"mapDiv\");\r\n            map.centerAndZoom(new T.LngLat(";
            string h1 = "), ";
            string h2 = ");\r\n\r\n\t\t\t\r\n";
            string h3 = "\t\t\t\r\n        }\r\n    </script>\r\n</head>\r\n<body onLoad=\"onLoad()\">\r\n<div id=\"mapDiv\"></div>\r\n</body>\r\n</html>";
        ...
        public static string MakeMapPointsTDT(IList<LocalData> ld)
        {
            ...
            for (int i = 0; i < ld.Count; i++)
            {
                string temp = "{title:\"" + "" + 
                    ...
                    "<br/>详细地址：" + ld[i].Address +
                    "<br/>其他信息：" + ld[i].OCW +
                    "<br/><a href=" + mainurl + "Detail.aspx?" + ld[i].ID + ">显示详情</a></p>" +
