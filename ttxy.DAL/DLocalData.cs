...
namespace ttxy.DAL
{
    public class DLocalData
    {
        public int INSERT(LocalData ld)
        {
            string sqlstr = "INSERT INTO yxg_localdata (b_name, addr, lng, lat, key_w, b_group, b_type, tele, pic, des, isused, OCW)VALUES('" +
                ld.Name + "', '" +
                ld.Address + "', " +
                ld.Lng + ", " +
                ld.Lat + ", '" +
        ...
        {
            string sqlstr = "UPDATE yxg_localdata SET b_name='" + ld.Name +
                "', addr='" + ld.Address +
                "', lng=" + ld.Lng +
                ", lat=" + ld.Lat +
                ", key_w='" + ld.Key_W +
        ...
        {
            string sqlstr = "SELECT id, b_name, addr, lng, lat, key_w, b_group, b_type, tele, pic, des, isused, OCW FROM yxg_localdata WHERE id=";
        ...
        {
            string sqlstr = "SELECT id, b_name, addr, lng, lat, key_w, b_group, b_type, tele, pic, des, isused, OCW FROM yxg_localdata WHERE addr='";
        ...
        {
            string sqlstr = "select id, b_name, addr, lng, lat, key_w, b_group, b_type, tele, pic, des, isused, OCW FROM yxg_localdata;";
        ...
        {
            string sqlstr = "select id, b_name, addr, lng, lat, key_w, b_group, b_type, tele, pic, des, isused, OCW FROM yxg_localdata WHERE isused=";
            string sqlend = ";";
        ...
        {
            string sqlstr = "select id, b_name, addr, lng, lat, key_w, b_group, b_type, tele, pic, des, isused, OCW FROM yxg_localdata WHERE b_group='";
            string sqlend = "';";
        ...
        {
            string sqlstr = "select id, b_name, addr, lng, lat, key_w, b_group, b_type, tele, pic, des, isused, OCW FROM yxg_localdata WHERE b_name like '%";
